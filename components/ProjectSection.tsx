  ...
  const projects: Project[] = [
    {
      ...
      description:
        "A premium digital platform engineered for a specialized medical clinic. Features a custom zero-maintenance CMS for managing medical achievements.",
    ...
    },
    {
      ...
      description:
        "A full-stack responsive solution with React, Node.js, and TailwindCSS. Features include dynamically chaning themes, realtime updating song gallery, and contact page integration with email.",
    ...
    },
    {
      title: "Jal Mitra",
      description:
        "A full-stack IoT system for real-time water level monitoring in railway reservoirs. Built the backend, dashboard, and sensor integration for a live government project.",
      ...
      <Container size="xl" px={{ base: "md", sm: "lg" }}>
        ...
        <FadeIn delay={0} direction="fade">
          <Stack align="center" gap="sm" mb={{ base: 40, sm: 64 }}>
            ...
            <Text fz="lg" c="gray.5" ta="center" maw={672}>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Text fz="sm" c="gray.5" lh={1.6} style={{ flex: 1 }}>
                    {project.description}
                  </Text>
