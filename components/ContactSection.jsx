            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-white/5 border rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-white/20 transition-colors disabled:opacity-50 ${errors.name
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  disabled={isSubmitting}
                  className={`w-full px-4 py-3 bg-white/5 border rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-white/20 transition-colors disabled:opacity-50 ${errors.email
                      ? 'border-red-500/50 focus:border-red-500/70'
                      : 'border-white/20 focus:border-white/30'
                    }`}
              ...
              <div>
                ...
                <textarea
                  ...
                  disabled={isSubmitting}
                  rows={5}
                  className={`w-full px-4 py-3 bg-white/5 border rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-white/20 transition-colors resize-none disabled:opacity-50 ${errors.message
                      ? 'border-red-500/50 focus:border-red-500/70'
                      : 'border-white/20 focus:border-white/30'
                    }`}
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-gray-400">
                    <a href="mailto:atharvchinchkar@gmail.com" className="hover:text-white transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-gray-400">
                    <a href="https://github.com/Atharv-0811" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-gray-400">
                    <a href="https://www.linkedin.com/in/atharv-chinchkar/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
